...
function HeaderRightContent(){
    ...
    return <div className="flex lg:items-center lg:flex-row flex-col gap-4 ">
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent side="right" className="w-56 bg-white shadow-md border border-gray-300">
                    <DropdownMenuLabel>
...
function ShoppingHeader() {
    ...
    return <header className="sticky top-0 z-40 w-full border-b border-gray-300 bg-background">
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
            ...
            <Sheet>
                ...
                <SheetContent side="left" className="w-full max-w-xs bg-white shadow-md border border-gray-300">
                <MenuItems/>
                <HeaderRightContent/>
                </SheetContent>
            </Sheet>
